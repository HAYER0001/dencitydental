      ...
      <div className="mx-auto max-w-6xl px-gutter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16">
          {doctors.map((doctor, index) => (
            <div
              key={index}
              className="group flex flex-col overflow-hidden rounded-card bg-background shadow-soft md:hover:shadow-card transition-shadow duration-300 border border-black/5 dark:border-white/10"
            >
              <div className="relative aspect-[3/4] w-full overflow-hidden bg-surface">
                ...
                <Image
                  ...
                  className="object-cover object-top origin-top grayscale transition duration-700 ease-out md:group-hover:grayscale-0 md:group-hover:scale-[1.04]"
                />
