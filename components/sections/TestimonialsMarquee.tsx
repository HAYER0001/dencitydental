        ...
        >
          {doubledTestimonials.map((testimonial, idx) => (
            <article
              ...
              tabIndex={0}
              className="flex h-full w-[22rem] shrink-0 flex-col justify-between rounded-none border border-[#0F1717]/5 bg-white p-7 shadow-none transition-all duration-[var(--duration-base)] md:hover:border-[#0A5C5C]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0A5C5C] focus-visible:border-[#0A5C5C]/35 cursor-grab active:cursor-grabbing"
